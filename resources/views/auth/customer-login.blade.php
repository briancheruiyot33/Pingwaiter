...
@section('content')
    <div class="mx-w-[475px] mx-auto text-center">
        ...
        <div class="p-5">
            <h2 class="text-4xl font-bold text-gray-900 font-playfair mb-2">Customer Sign In</h2>
            ...
            <div class="text-center mb-4">
                ...
                <a href="{{ route('google.login', ['redirect' => route('table.menu', ['table' => $tableCode]), 'role' => 'customer']) }}"
                    id="google-signin"
