...
@section('content')
    ...
    <div class="mx-w-[475px] mx-auto text-center">
        ...
        <h2 class="text-4xl font-bold text-gray-900 font-playfair mb-2">Create New Account</h2>
        <p class="text-gray-600 text-lg mb-6">Sign up with your Google account to continue</p>
        ...
        <div class="mb-16">
            <div class="custom-steps">
                ...
                <div class="step-item">
                    ...
                    <div class="step-label">Restaurant Details</div>
                </div>
        ...
        <div class="text-center mb-4 mt-4">
            ...
            <div class="mt-6">
                <a href="{{ route('demo.login') }}" class="text-[#8065ee] font-semibold hover:underline">
                    Try Demo Instead
                </a>
            </div>
            ...
            <div class="mt-4 text-gray-600">
                Already have an account? <a href="{{ url('restaurant/login') }}"
                    class="text-[#8065ee] font-semibold hover:underline">Login
                </a>
            </div>
        </div>
    </div>
