...
return [
    'backup' => [
        ...
        'source' => [
            ...
            'db_dump_compressor' => [
                'mysql' => [
                    //'dump_binary_path' => '/path/to/mysqldump', // Optional: specify if mysqldump is not in PATH
    ...
    'notifications' => [
      ...
      /*  'mail' => [
        ...
        'mail' => [
            'to' => 'mekiermena60@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'mekiermena72@gmail.com'),
